...
export const zh = {
  ...
  settingsImageDirDesc: '![[图.png]] 的解析目录：相对会话目录（默认 images）或绝对路径',
...
export const en: Record<keyof typeof zh, string> = {
  ...
  settingsImageDirDesc: 'Directory that ![[x.png]] embeds resolve against: relative to the session cwd (default images), or an absolute path',
  settingsImageDirPlaceholder: 'images',
  viewerCode: 'Code',
